...
List<Question> getQuestions() {
  List<Question> list = [];
  list.add(Question(
    "Gravitational Acceleration has value of ?",
    [
      Answer("5.23", false),
      Answer("3.42", false),
      Answer("9.8", true),
  ...
  list.add(Question(
    ...
    [
      Answer("850 watts ", false),
      Answer("746 watts", true),
      Answer("120 watts", false),
      Answer("590 watts", false),
    ],
  ));
  ...
  list.add(Question(
    "Sound waves are",
    [
      Answer("infrasonics", false),
      Answer("ultraviolet", false),
      Answer("longitudinal", true),
      Answer("transverse", false),
    ],
  ));

  list.add(Question(
    "Focal length of concave lense is considered as ",
    [
