...
List<Question> getQuestions() {
  ...
  list.add(Question(
    "faint means ____",
    [
      Answer("feel pride", false),
      Answer("laughs", false),
      Answer("lose senses", true),
      Answer("fall down", false),
    ],
  ));

  list.add(Question(
    "Put out is synonym for ",
    [
      Answer("quench", false),
      Answer("show off", false),
      Answer("give of", false),
      Answer("extinguish", true),
    ],
  ));
  list.add(Question(
    "Prey means ",
    [
      Answer("To be hunted", true),
      Answer("hunter", false),
      Answer("forest", false),
      Answer("forecast", false),
    ],
  ));
